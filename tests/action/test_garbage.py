...
class TestGarbage(unittest.TestCase):
    def test_exec(self):
        ...
        expect_result_1 = [os.path.join(path, "folder.jpg"), os.path.join(path, "info.nfo"),
        ...
        expect_result_2 =[os.path.join(path, "folder.jpg"), os.path.join(path, "info.nfo"),
                                  os.path.join(path, "test.mht")]
        ...
        expect_result_3 = [os.path.join(path, "fol", "folder.jpg"), os.path.join(path, "fol", "info.nfo"),
        ...
        self.assertTrue(os.path.exists(os.path.join(path, "fol", "folder.jpg")))
        self.assertTrue(os.path.exists(os.path.join(path, "fol", "test.mht")))
        expect_result_4 = [os.path.join(path, "fol", "folder.jpg"), os.path.join(path, "fol", "info.nfo"),
                                  os.path.join(path, "fol", "test.mht"), os.path.join(path, "fol")]
